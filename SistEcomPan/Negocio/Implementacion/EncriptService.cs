       ...
       public string EncriptarPassword(string password)
        {
            ...
            {
                aesAlg.Key = Encoding.UTF8.GetBytes("EstaEsLaClaveSecreta"); // Clave secreta (debería ser almacenada de forma segura)
        ...
        public string DesencriptarPassword(string encryptedPassword)
        {
            using (Aes aesAlg = Aes.Create())
            {
                aesAlg.Key = Encoding.UTF8.GetBytes("EstaEsLaClaveSecreta"); // La misma clave usada para encriptar
